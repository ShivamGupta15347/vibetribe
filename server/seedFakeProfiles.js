...
async function createFakeProfiles() {
    try {
        console.log('🌱 Starting to create fake Indian girl profiles...');
        ...
        console.log(`\n🎉 Successfully created ${createdProfiles.length} fake Indian girl profiles!`);
        console.log('📊 Summary:');
...
module.exports = { createFakeProfiles }; 